...
AI-powered development assistant for multi-file project generation and modification.

Capabilities:
- Full-stack web application generation
- Multi-language code generation (Python, JavaScript, HTML, CSS, etc.)
- Project structure creation
- Code execution and testing
- Error fixing with iterative attempts
- Terminal command execution
- Build system setup (npm, pip, etc.)

Architecture:
- Planner module: Creates step-by-step plan
- Writer module: Generates code files
- Executor: Runs commands and handles errors
- Error recovery: Automatic fixing up to 5 attempts

UPCOMING FEATURES:
- [ ] Type-aware code generation (TypeScript, Go, Rust)
- [ ] Framework-specific scaffolding (React, Vue, Django, FastAPI)
- [ ] Git integration (version control, commits)
- [ ] Testing framework auto-setup (pytest, Jest, etc.)
- [ ] CI/CD pipeline generation (GitHub Actions, GitLab CI)
- [ ] Docker containerization support
- [ ] Performance profiling integration
- [ ] Documentation generation (JSDoc, Python docstrings)
...
- Support monorepo management
- Add machine learning model scaffolding
- Implement database migration tools
- Support microservices architecture generation
- Add serverless function scaffolding
- Support blockchain/Web3 contracts
- Implement mobile app generation (React Native, Flutter)
- Add AR/VR application templates
"""
...
def _get_model(model_name: str):
    ...
    return client.models.get_model(model=model_name)
