...
Decomposes complex multi-step tasks into executable tool sequences.

Role:
- Receives high-level user goals
- Analyzes available tools and their parameters
- Creates step-by-step execution plan
- Ensures tool parameters are concrete (no template values)
- Optimizes step count and dependencies

Key Rules:
1. Max 5 steps per plan (promote efficiency)
2. Each step is independent (no parameter references)
3. Use web_search for information retrieval
4. Never generate code or reference non-existent tools
5. Prioritize direct tool use over multi-step workflows

Planning Strategy:
- Analyze task complexity
- Identify minimal required steps
- Order steps by dependencies
- Validate parameter completeness
- Add error handling steps if needed

UPCOMING FEATURES:
- [ ] Constraint-based planning (max time, cost, etc.)
- [ ] Probabilistic planning with confidence scores
- [ ] Parallel execution detection
- [ ] Resource requirement analysis
- [ ] Learning from past successful plans
- [ ] Plan explanation generation
- [ ] Plan modification and replanning
- [ ] Cost estimation for cloud operations
- [ ] Environmental impact tracking
- [ ] Multi-objective optimization

NEXT UPDATE IDEAS:
- Add plan branching for different outcomes
- Implement rollback planning
- Support conditional logic (if/else steps)
- Add plan templates for common scenarios
- Implement step scheduling/timing
- Add dependency graph visualization
- Support plan versioning and rollback
- Implement plan optimization algorithms
- Add A/B testing framework for plan variants
"""
